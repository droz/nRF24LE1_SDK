...
#define TIMER2_CONFIG_OPTION_CMP_CAPT_CRC_COMPARE_ENABLED   	((0x02 << CCEN_CRC_MODE_SHIFT) << TIMER2_CONFIG_OPTION_CCEN_OFFSET_SHIFT)		//Enable capturing the value of TH2 into CRC when a write is done to CRCL
