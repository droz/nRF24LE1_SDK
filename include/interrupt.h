...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __SDCC
#define INTERRUPT(isr_name, vector_num)     void isr_name()
#else
#define INTERRUPT(isr_name, vector_num)     void isr_name()  __interrupt(vector_num)
#endif


#define interrupt_isr_ifp()          INTERRUPT(isr_ifp         , INTERRUPT_VECTOR_IFP)            //Interrupt from pin interrupt function header
#define interrupt_isr_t0()           INTERRUPT(isr_t0          , INTERRUPT_VECTOR_T0)             //Timer 0 interrupt function header
#define interrupt_isr_pwr_fail()     INTERRUPT(isr_pwr_fail    , INTERRUPT_VECTOR_PWR_FAIL)       //Power failure interrupt function header
#define interrupt_isr_t1()           INTERRUPT(isr_t1          , INTERRUPT_VECTOR_T1)             //Timer 1 interrupt function header
#define interrupt_isr_uart()         INTERRUPT(isr_uart        , INTERRUPT_VECTOR_UART)           //UART interrupt function header
#define interrupt_isr_t2()           INTERRUPT(isr_t2          , INTERRUPT_VECTOR_T2)             //Timer 2 interrupt function header
#define interrupt_isr_rfrdy()        INTERRUPT(isr_rfrdy       , INTERRUPT_VECTOR_RFRDY)          //RF SPI ready interrupt function header
#define interrupt_isr_rfirq()        INTERRUPT(isr_rfirq       , INTERRUPT_VECTOR_RFIRQ)          //RF communication interrupt function header
#define interrupt_isr_spi_2wire()    INTERRUPT(isr_spi         , INTERRUPT_VECTOR_SPI_2WIRE)      //SPI/2 wire interrupt function header
#define interrupt_isr_wu_on_pin()    INTERRUPT(isr_wu_on_pin   , INTERRUPT_VECTOR_WU_ON_PIN)      //Wake-up on pin interrupt function header
#define interrupt_isr_xosc_adc_rng() INTERRUPT(isr_xosc_adc_rng, INTERRUPT_VECTOR_XOSC_ADC_RNG)   //X0SC16M started/ADC ready/RNG ready interrupt function header
#define interrupt_isr_rtc2()         INTERRUPT(isr_rtc2        , INTERRUPT_VECTOR_RTC2)           //Internal wakeup from RTC2 interrupt function header
